#!/usr/bin/env python3
"""
Forex RORO Backtest V4 — FTMO $120k Challenge
==============================================
V4 improvement over V3: Daily-trend gating in build_macro().
...
def main():
    ...
    print(f"\n{'='*88}")
    print(f"  FINAL COMPARISON V4 — Daily-Trend Gate + 1H EMA50 Filter + JPY Carry Guard")
    print(f"{'='*88}")
